...
const STATUS_COLOR: Record<JEStatus, string> = {
  ...
  'Reversed':         'bg-amber-900/50 text-amber-300',
    ...
    <div className="space-y-6" dir="rtl">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {[
          ...
          { label: 'معكوس هذا الشهر', value: kpis.reversedThisMonth, icon: 'undo', color: 'text-amber-400', bg: 'bg-amber-900/20' },
                  ...
                  <tr key={e.id} className="hover:bg-gray-700/20 transition-colors">
                    ...
                    <Td>
                      <div className="flex items-center gap-1">
                        ...
                        {e.status === 'Posted' && (
                          <button onClick={() => openReversal(e)} title="عكس القيد" className="p-1 hover:bg-amber-900/50 rounded text-amber-400 transition-colors">
      ...
      <div className="space-y-5" dir="rtl">
            ...
            <div className="flex items-center gap-2">
              ...
              {e.status === 'Posted' && (
                <button onClick={() => openReversal(e)}
                  className="flex items-center gap-1 px-3 py-1.5 bg-amber-700 text-white rounded-lg text-xs hover:bg-amber-600 transition-colors">
                ...
                <div key={h.id} className="flex items-start gap-3">
                  <div className="flex flex-col items-center">
                    <div className={`w-2 h-2 rounded-full mt-1.5 ${
                      ...
                      h.action === 'reversed' ? 'bg-amber-400' : 'bg-yellow-400'
                    }`} />
        ...
        {e.reversal_of_entry_id && (
          <div className="bg-amber-900/20 border border-amber-700/40 rounded-xl p-4 flex items-center gap-3">
            <span className="material-icons text-amber-400">undo</span>
            <div>
              <p className="text-sm text-amber-300 font-medium">هذا قيد عكسي</p>
  ...
  const renderReversal = () => {
    ...
    return (
      <div className="max-w-2xl" dir="rtl">
        <div className="bg-[#1e2736] rounded-xl border border-amber-700/40 p-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input type="date" value={reversalDate} onChange={e2 => setReversalDate(e2.target.value)}
                className="w-full bg-[#161d2b] border border-gray-600 rounded-lg px-3 py-2 text-sm text-gray-300 focus:ring-1 focus:ring-amber-500" />
            </div>
            <div>
            ...
            <div className="flex gap-3">
              <button onClick={executeReversal}
                className="flex items-center gap-2 px-4 py-2.5 bg-amber-700 text-white rounded-lg hover:bg-amber-600 text-sm font-medium transition-colors">
