...
import { User, Asset, MaintenanceRequest, Project } from '../types';
...
const AssetDashboard: React.FC<AssetDashboardProps> = ({ user }) => {
  ...
  const canManageAssets = user.role === 'project_manager' || user.role === 'super_admin' || user.role === 'power_admin' || user.role === 'it_specialist';
